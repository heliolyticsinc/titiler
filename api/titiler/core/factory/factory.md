...
class BaseTilerFactory(
    ...
    path_dependency: Callable[..., Any] = <function DatasetPathParams at 0x7f7e6ec0aaf0>,
    ...
    colormap_dependency: Callable[..., Union[Dict[int, Tuple[int, int, int, int]], Sequence[Tuple[Tuple[Union[float, int], Union[float, int]], Tuple[int, int, int, int]]], NoneType]] = <function ColorMapParams at 0x7f7e6ed80dc0>,
    ...
    tms_dependency: Callable[..., morecantile.models.TileMatrixSet] = <function TMSParams at 0x7f7e717b9550>,
    router_prefix: str = '',
